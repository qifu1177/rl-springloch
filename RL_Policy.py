...
class Policy:
    def __init__(self, actions, n_state=4, lr=0.01, reward_decay=0.95, n_l1=200):
    ...
    def build_net(self):
        ...
        with tf.variable_scope("l1"):
            l1 = tf.layers.dense(self.states, self.n_l1, activation=tf.nn.tanh,
    ...
    def choose_action(self, state, other_state):
