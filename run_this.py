...
2. Der Spieler darf sich nur nach oben, unter, links und recht bewegen
3. Der Spieler darf nicht auf eine Position, die besitzt wurd,gehen.
4. Der Spieler darf im Aus von der Schachbrett sein.
'''''
import numpy as np
